...
import InvestorEducationDisclaimer from "@/components/common/InvestorEducationDisclaimer";
        ...
        <div className="container-custom">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="section-title mt-6">
              Explore.
              <span className="block text-green-700">Learn. Calculate.</span>
            </h2>
            <p className="section-subtitle">
              Explore hypothetical investment, inflation and withdrawal
              scenarios using the assumptions you enter. These tools do not
              determine or recommend a suitable investment amount, scheme or
...
=======
          <div className="mt-14 grid gap-7 md:grid-cols-2 xl:grid-cols-3">
            <CalculatorCard
              title="SIP Calculator"
              description="Explore the illustrative future value of regular monthly SIP contributions based on the assumptions you enter."
              href="/calculators/sip"
            ...
            <CalculatorCard
              title="Lumpsum Calculator"
              description="Explore the illustrative future value of a one-time investment using the amount, period and illustrative return assumption entered."
              href="/calculators/lumpsum"
            ...
            <CalculatorCard
              title="SWP Calculator"
              description="Explore an illustrative systematic withdrawal scenario and how periodic withdrawals may affect an investment value over time."
              href="/calculators/swp"
            ...
            <div className="rounded-3xl border border-green-200 bg-green-50 p-8 lg:p-10">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="mt-4 leading-8 text-slate-700">
                    These calculators help investors understand the effect of
                    investment amount, time, inflation, withdrawals and
                    hypothetical return assumptions through simple
                    illustrations.
                  </p>
                </div>
              </div>
            ...
            <div className="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm lg:p-10">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="mt-4 leading-8 text-slate-700">
                    Results are hypothetical, assumption-based illustrations.
                    They do not represent a recommendation, promise, guarantee
                    or assurance of any particular return or future value.
                  </p>
                </div>
              </div>
            </div>
