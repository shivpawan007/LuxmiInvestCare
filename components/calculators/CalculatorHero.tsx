      ...
      <div className="container-custom relative z-10">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <h1 className="mt-8 text-5xl font-extrabold leading-tight lg:text-6xl">
            Investment Illustration Calculators
          </h1>
          <p className="mx-auto mt-8 max-w-3xl text-lg leading-8 text-green-100 lg:text-xl">
            Explore hypothetical investment, inflation and withdrawal scenarios
            using the assumptions you enter. These tools are for investor
            education and illustration only.
          </p>
          <div className="mt-12 flex flex-wrap justify-center gap-8 text-sm sm:text-base">
            <div className="flex items-center gap-3">
              ...
              <span>Investor Education</span>            </div>
            <div className="flex items-center gap-3">
